...
<link href="../css/applicant_regist.css" rel="stylesheet"
	type="text/css" />
				...
				<table id="tab1" class="page">
					<tr>
						...
						<td><input type="hidden" name="id"
							value="<c:out value="${ info.id }" />"> <fmt:formatNumber
								value="${ info.id }" pattern="00000000" /></td>
					</tr>
					<tr>
						<th>求職者氏名</th>
				...
				<table id="tab2" class="page">
					...
					<tr>
						...
						<td><label><input type="checkbox"
								name="hopekoyoukeitai" value="1">正社員</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="2">契約社員</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="3">パート</label></td>
					</tr>
					<tr>
						<th>希望勤務曜日</th>
						<td><label><input type="checkbox"
								name="hopekoyoukeitai" value="1">月</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="2">火</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="3">水</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="4">木</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="5">金</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="6">土</label> <label><input
								type="checkbox" name="hopekoyoukeitai" value="7">日</label></td>
					</tr>
					<tr>
						<th>希望勤務日数</th>
